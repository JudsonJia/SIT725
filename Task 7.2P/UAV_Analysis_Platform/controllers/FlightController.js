    ...
    async uploadFlightData(req, res) {
        try {
            ...
            if (global.socketUtils) {
                global.socketUtils.emitAnalysisProgress('temp', 10);
            }
            ...
            if (global.socketUtils) {
                global.socketUtils.emitAnalysisProgress('temp', 30);
            }
            ...
            if (!validation.valid) {
                ...
                if (global.socketUtils) {
                    global.socketUtils.emitAnalysisError('temp', new Error(validation.error));
                }
                return res.status(400).json({
                    success: false,
            ...
            if (global.socketUtils) {
                global.socketUtils.emitAnalysisProgress('temp', 50);
            }
            ...
            if (global.socketUtils) {
                global.socketUtils.emitAnalysisProgress('temp', 80);
            }
            ...
            if (global.socketUtils) {
                global.socketUtils.emitAnalysisComplete(flightData._id, {
            ...
            if (global.socketUtils) {
                global.socketUtils.emitAnalysisError('temp', error);
            }
